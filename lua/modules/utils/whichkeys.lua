return {
    ...
    { "<leader><leader>c", group = "Search-Replace", icon = { icon = "󰛔", color = "cyan" } },
    { "<leader><leader>cW", "<CMD>SearchReplaceSingleBufferCWORD<CR>", desc = "[W]ORD" },
    { "<leader><leader>cb", group = "Search-Replace-MultiBuffer" },
    { "<leader><leader>cbW", "<CMD>SearchReplaceMultiBufferCWORD<CR>", desc = "[W]ORD" },
    { "<leader><leader>cbe", "<CMD>SearchReplaceMultiBufferCExpr<CR>", desc = "[e]xpr" },
    { "<leader><leader>cbf", "<CMD>SearchReplaceMultiBufferCFile<CR>", desc = "[f]ile" },
    { "<leader><leader>cbo", "<CMD>SearchReplaceMultiBufferOpen<CR>", desc = "[o]pen" },
    {
        "<leader><leader>cbs",
    ...
    { "<leader><leader>cbw", "<CMD>SearchReplaceMultiBufferCWord<CR>", desc = "[w]ord" },
    { "<leader><leader>ce", "<CMD>SearchReplaceSingleBufferCExpr<CR>", desc = "[e]xpr" },
    { "<leader><leader>cf", "<CMD>SearchReplaceSingleBufferCFile<CR>", desc = "[f]ile" },
    { "<leader><leader>co", "<CMD>SearchReplaceSingleBufferOpen<CR>", desc = "[o]pen" },
    {
        "<leader><leader>cs",
        "<CMD>SearchReplaceSingleBufferSelections<CR>",
        desc = "SearchReplaceSingleBuffer [s]elction list",
    },
    { "<leader><leader>cw", "<CMD>SearchReplaceSingleBufferCWord<CR>", desc = "[w]ord", nowait = true, remap = false },
    ...
    { "<leader>mF", "<cmd>Obsidian tags<CR>", desc = "find Tags" },
    { "<leader>mI", "<cmd>Obsidian link_new<CR>", desc = "Create new link" },
    { "<leader>mR", "<cmd>Obsidian rename<CR>", desc = "Rename File" },
    { "<leader>mT", "<cmd>Obsidian tomorrow<cr>", desc = "Open Tomorrow File" },
    { "<leader>md", "<cmd>Obsidian dailies<CR>", desc = "Dailies" },
    { "<leader>me", "<cmd>Obsidian template<CR>", desc = "Template" },
    { "<leader>mf", "<cmd>Obsidian backlinks<CR>", desc = "find References" },
    { "<leader>mi", "<cmd>Obsidian links<CR>", desc = "List Link" },
    ...
    { "<leader>mn", "<cmd>Obsidian new<CR>", desc = "Create new file" },
    { "<leader>mO", "<cmd>Obsidian open<cr>", desc = "Open File" },
    { "<leader>mp", "<cmd>PencilToggle<CR>", desc = "Pencil Toggle" },
    { "<leader>mq", "<cmd>Obsidian quick_switch<CR>", desc = "Quick Switch" },
    { "<leader>ms", "<cmd>Obsidian search<CR>", desc = "Search File" },
    { "<leader>mo", "<cmd>Obsidian today<cr>", desc = "Open Today File" },
    { "<leader>mx", "<cmd>Obsidian extract_note<cr>", desc = "Extract Note" },
    { "<leader>my", "<cmd>Obsidian yesterday<cr>", desc = "Open Yesterday File" },
    ...
    { "<leader>sb", "<Cmd>lua require('telescope.builtin').buffers({sort_lastused = true, previewer = true})<CR>", desc = "Buffers" },
    {
        "<leader>sc",
    ...
    { "<leader>sf", "<Cmd>lua require('telescope.builtin').find_files({previewer = true})<CR>", desc = "Find files" },
    { "<leader>sh", group = "Help" },
    { "<leader>shh", "<cmd>Telescope help_tags<cr>", desc = "Help Tags" },
    ...
    { "<leader>ss", "<cmd>Obsidian search<CR>", desc = "Personal Files" },
