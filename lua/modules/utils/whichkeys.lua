return {
  ...
  a = {
    ...
    i = { [[<cmd>lua require("harpoon.ui").nav_file(4)<CR>]], "go to 4" },
    n = { [[<cmd>lua require("harpoon.ui").nav_file(7)<CR>]], "go to 7" },
    o = { [[<cmd>lua require("harpoon.ui").nav_file(5)<CR>]], "go to 5" },
    p = { [[<cmd>lua require("harpoon.ui").nav_file(6)<CR>]], "go to 6" },
    r = { [[<cmd>lua require("harpoon.ui").nav_file(1)<CR>]], "Go to 1" },
  ...
  w = {
    ...
    b = { "<cmd>Block<CR>", "Enable Toggle Block" },
    c = { "<cmd>ColorizerToggle<CR>", "Display Colours in File" },
    ...
    u = { "<cmd>UndotreeToggle<CR>", "Buffer History" },
  },
