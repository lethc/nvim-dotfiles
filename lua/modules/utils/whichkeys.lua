return {
    ...
    { "<leader>mmC", "<cmd>MkdnTableNewColBefore<cr>", desc = "TableNewColBefore" },
    { "<leader>mmN", "<cmd>MkdnDestroyLink<cr>", desc = "DestroyLink" },
    { "<leader>mmR", "<cmd>MkdnTableNewRowAbove<cr>", desc = "TableNewRowAfter" },
    { "<leader>mmc", "<cmd>MkdnTableNewColAfter<cr>", desc = "TableNewColAfter" },
    { "<leader>mmf", "<cmd>MkdnTableFormat<cr>", desc = "FormatTable" },
    { "<leader>mml", "<cmd>MkdnExtendList<cr>", desc = "NewListNoMove" },
    { "<leader>mmn", "<cmd>MkdnCreateLink<cr>", desc = "CreateLink" },
    { "<leader>mmr", "<cmd>MkdnTableNewRowBelow<cr>", desc = "TableNewRowBelow" },
    ...
    { "<leader>mt", "<cmd>ObsidianToday<cr>", desc = "Open Today File" },
    ...
    { "<leader>soa", "<cmd>TodoTelescope<cr>", desc = "Search for All comments" },
    {
        "<leader>sof",
    ...
    {
        "<leader>soh",
        "<cmd>TodoTelescope keywords=HACK<cr>",
    ...
    {
        "<leader>soo",
        "<cmd>TodoTelescope cwd=~/Home/<cr>",
        desc = "Search in a specific folder",
    },
    {
        "<leader>sop",
        "<cmd>TodoTelescope keywords=PERF<cr>",
