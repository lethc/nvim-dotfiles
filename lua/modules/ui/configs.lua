...
config.themery = function()
  ...
  themery.setup({
    themes = { "no-clown-fiesta", "lvim", "nightly", "astromars", "astrodark", "aesthetic", "mellifluous", "mellow", "gabriel", "my_vivid", "leeward", "arctic", "nightcity", "nightcity-kabuki", "nightcity-afterlife", "tokyonight" },
