...
M.options = function()
    local N = {
        ...
        guifont = { "Maple Mono NF:h11" },                                   -- the font used in graphical neovim applications
        ...
        scrolloff = 2, --99(cursor in center)                                       -- minimal number of screen lines to keep above and below the cursor
