  ...
  let s:guishade2 = "#45475e"
  let s:guishade3 = "#565a7a"
  let s:guishade4 = "#676e95"
  let s:guishade5 = "#7881b1"
  let s:guishade6 = "#8a95cc"
  let s:guishade7 = "#9ba8e8"
  let s:guiaccent0 = "#8e86fe"
  let s:guiaccent1 = "#9bcbe8"
  let s:guiaccent2 = "#9be8b9"
  let s:guiaccent3 = "#d4e89b"
  let s:guiaccent4 = "#f5a38e"
  let s:guiaccent5 = "#f78d8d"
  let s:guiaccent6 = "#e66b6b"
  let s:guiaccent7 = "#ef4d4d"
  ...
  let s:ctermshade6 = 146
  let s:ctermshade7 = 147
  let s:ctermaccent0 = 147
